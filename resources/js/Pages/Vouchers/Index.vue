                    ...
                    >
                        ...
                        >
                            <Link
                                v-if="link.url"
                                :href="link.url"
                                class="rounded-md px-4 py-2 text-sm font-medium leading-5 transition duration-150 ease-in-out focus:outline-none"
                                :class="{
                            ...
                            <span
                                v-else
                                class="cursor-not-allowed rounded-md px-4 py-2 text-sm font-medium leading-5 text-gray-400"
                                v-html="link.label"
                            ></span>
                        </template>
                    </div>
