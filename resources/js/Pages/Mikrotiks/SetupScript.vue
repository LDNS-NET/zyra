        ...
        <div class="mx-auto max-w-3xl py-8">
            <div class="rounded bg-white p-6 shadow">
                <p class="mb-4 text-gray-700">
                    <b>Step 1:</b> Copy or download the script below and run it
                    in your Mikrotik terminal (Winbox, WebFig, or SSH).<br />
                    <b>Step 2:</b> After running the script, copy the IP address
                    shown in the output and paste it into the system to complete
                    onboarding.<br />
                    <b>Step 3:</b> Click <b>I've run the script</b> to begin
                    checking if your router is online. Once detected, you can
                    continue.
                </p>
                <div
                    class="mb-4 rounded border-l-4 border-blue-400 bg-blue-50 p-4 text-blue-900"
                >
                ...
                <div class="mb-4 flex gap-2">
                    <PrimaryButton
                        ...
                        >I've run the script</PrimaryButton
                    >
                    <span
                        v-if="waiting"
                        ...
                        >
                            ...
                            ></path></svg
                        >Waiting for router to come online...</span
                    >
                    <span v-if="online" class="font-semibold text-green-600"
                        >Router is online! You can continue.</span
                    >
                    <span v-if="pollingError" class="text-red-600">{{
                        pollingError
                    }}</span>
                </div>
